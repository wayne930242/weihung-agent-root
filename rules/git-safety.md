...
- Before committing a new `.gitignore` pattern, run `git check-ignore -v <tracked-file>` on currently-tracked files that could match; ensure no tracked files are accidentally shadowed.
