...
- `claude`: uses `--model sonnet` with `--effort low` or `high`, `--model 'claude-opus-5-5[1m]' --effort low`, or `--model 'claude-opus-5-5[1m]' --effort xhigh`.
