...
| `pi-notify` | A desktop notification when pi is ready for input. |
...
- 安裝內容：pi 本體與 Herdr 整合、上表的 pi 套件（Herdr pane 派工、intercom、ask_user、todo、footer 與主題、MCP、網路搜尋、pi-lens、通知、用量、session 備份、pi-skills）、aaaav、本 repo 的擴充（派工紀錄與復原、主代理移交、閒置時自動壓縮、mp-infra 安全 hook），以及 codebase-memory、mp-infra（有 checkout 時）與 team-toon-tack。
