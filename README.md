...
目前最佳策略為 `claude-only`：例行派工全部留在 Claude，Opus 5.5 xhigh 協調，Sonnet low 承接明確小修改與查找整理，Sonnet high 一般實作與文件，Opus 5.5 1M low 承接 UI/UX 審查與指示清楚的複雜工作，Opus 5.5 1M xhigh 承接指示不清的複雜工作。
